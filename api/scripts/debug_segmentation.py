...
def main():
    ...
    cols = ["hr_bpm", "power_w", "cadence_spm", "stride_length_mm", "vertical_oscillation_cm", "ground_contact_time_ms", "vertical_ratio", "body_battery", "temperature_c", "elevation_m"]
    ...
    print(raw_15s[["time_block_15s", "is_work", "time_bucket", "is_work_diff", "time_bucket_diff", "change", "segment_id"]].head(15))
