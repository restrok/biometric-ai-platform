...
from src.agent.graph import node_injury_prevention, node_sleep_recovery, node_metabolic_nutrition, AgentState
from langchain_core.messages import HumanMessage

async def test_agent():
    # Mock state with a mix of poor sleep, high load, and ectomorph profile
    state = {
        "messages": [HumanMessage(content="Ayer corrí 10k fuerte. ¿Qué debería comer hoy para recuperar bien y cómo estoy para entrenar?")],
        "biometric_context": {
            "recent_activities": [
                {
                    "id": "12345",
            ...
            "hrv": [
                {"date": "2026-05-24", "avg_hrv": 34.0, "baseline_low": 38.0, "status": "UNBALANCED"}
            ],
            "sleep": {
                "date": "2026-05-24",
            ...
            "personal_calibration_profile": [
                {"marker_type": "ac_ratio_red_line", "marker_value": 1.45}
            ],
            "training_status": {
                "acute_load": "42.0",
                "chronic_load": "25.0",
