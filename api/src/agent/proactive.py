...
def _request_rpe(user_id, activity_id):
    ...
    msg = (
        f"🏃 *Activity Synced: Tigre Running*\n\n"
        f"Great job on your run! To calibrate your recovery model, "
        f"how did you feel on a scale of 1-10? (1 = very easy, 10 = max effort)"
    )
