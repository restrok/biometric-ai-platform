        ...
        if table_name == "recent_activities":
            ...
            for _, row in df.iterrows():
                ...
                rec = {
                    ...
                    "body_battery_charged_sleep": int(row["body_battery_charged_sleep"]) if "body_battery_charged_sleep" in row and pd.notna(row["body_battery_charged_sleep"]) else None,
                }
