...
- **Max HR Auto-Calibration (`calibrate_profile_max_hr`):** Added tool detecting when real telemetry peak HR exceeds stored profile `max_hr` (e.g. 179 bpm vs 123 bpm default), updating Firestore and BigQuery profiles, and recalculating Karvonen Z1-Z5 zones.
